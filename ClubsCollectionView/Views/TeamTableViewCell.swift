...
extension TeamTableViewCell {
    ...
    func configure(with item : League, delegate: TeamTableViewCellDelegate) {
        ...
        for team in item.teams {
            containerVw.backgroundColor = team.id.PremierLeagueBackground
            ...
            stadiumLabel.text = team.id.PremierLeagueStadium
